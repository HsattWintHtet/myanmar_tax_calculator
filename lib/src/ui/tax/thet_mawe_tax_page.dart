...
class ThetMaweTaxCalculationPage extends StatefulWidget {
  @override
  _MyAppState createState() => new _MyAppState();
}

class _MyAppState extends State<ThetMaweTaxCalculationPage> {
  final _formKey = GlobalKey<FormState>();

  final ThetMaweBizTaxBloc _thetMaweBizTaxBloc = ThetMaweBizTaxBloc();
  ...
  void _onMaritalStatusOptionChange(int value) {
    _thetMaweBizTaxBloc.dispatch(MaritalStatusChangeEvent(value));
  }

  void _onIncomeTextChange() {
    _thetMaweBizTaxBloc.dispatch(
  ...
  void _onExpenseTextChange() {
    _thetMaweBizTaxBloc.dispatch(ExpenseTextChangeEvent(
  ...
  void _onParentAllowanceTextChange() {
    ...
    if(value != null && value <= 4) {
      _thetMaweBizTaxBloc.dispatch(NoOfParentChangeEvent(value));
    }
  }
  ...
  void _clearTextField() {
    ...
    _thetMaweBizTaxBloc.dispatch(ClearEvent());
  }
  ...
  void dispose() {
    ...
    _thetMaweBizTaxBloc.dispose();
  }

  void _onBizTypeOptionChange(int value) {
    _thetMaweBizTaxBloc.dispatch(BizOptionChangeEvent(value));
  }


  void _onYearOptionChange(int newValue) {
    _thetMaweBizTaxBloc.dispatch(YearOptionChangeEvent(newValue));
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder(
        bloc: _thetMaweBizTaxBloc,
        builder: (BuildContext context, ThetMaweBizTaxState state) {
          return Form(
              key: _formKey,
              child: ListView(
                  shrinkWrap: true,
                    ...
                    DropdownButtonHideUnderline(
                      child: InputDecorator(
                        ...
                        child: DropdownButton<int>(
                          ...
                          items: _thetMaweBizTaxBloc.yearList.entries.map((MapEntry<int, List> e) {
